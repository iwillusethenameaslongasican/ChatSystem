...
public:
    ...
    //修改好友备注
    void changeFriendRemark(const QString &myID, const QString &friendID,
                            const QString &remark);

    //删除好友
    void deleteFriend(const QString &myID, const QString &friendID);
    //添加好友
    void addFriend(const TalkMessage &msg);


    //加入群
    void addFlock(const TalkMessage &msg);
    //加入讨论组
    void addDiscussion(const TalkMessage &msg);
    //解散群
    ...
    //退出讨论组
    void leaveDiscussion(const QString &, const QString &);
    //创建群
    ...
    //好友请求结果
    void resultOfFriendRequest(const TalkMessage &msg);
    //群请求结果
    void resultOfFlockRequest(const TalkMessage &msg);
 ...
 signals:
    void getFriendSuccess(const QVector<FriendInformation> &);
    void getFlockSuccess(const QVector<FlockInformation> &);
    void getDiscussionSuccess(const QVector<DiscussionInformation> &);
    ...
    void getFriendChangeStatus(const QString &, const int);
    void getFriendChangeInformation(const FriendInformation &);
    ...
    void leaveFlockSuccess(const QString &, const QString &, QString &);
    void haveMemberLeaveFlock(const QString &, const QString &, const QString &);
    void changeFlockSuccess(const FlockInformation &);
    void changeFlockRemarkSuccess(const TempStrings &tmpStr);
    ...
    void getNetworkHistoryMessageSuccess(const QString &friendID, const QDate &date,
...
public slots:
    ...
    //发送修改好友备注的请求
    void requestChangeFriendRemark(const QString &myID, const QString &friendID,
                                   const QString &remark);
    //发送删除好友的请求
    void requestDeleteFriend(const QString &myID, const QString &friendID);
    //发送添加好友的请求
    void requestAddFriend(const TalkMessage &msg);
    //发送加入群的请求
    void requestAddFlock(const TalkMessage &msg);
    //发送加入讨论组的请求
    void requestAddDiscussion(const TalkMessage &msg);
    //发送解散群的请求
    ...
    //发送处理好友请求结果的请求
    void requestSendResultOfFriendRequest(const TalkMessage &msg);
    //发送处理群请求结果的请求
    void requestSendResultOfFlockRequest(const TalkMessage &msg);

    //发送修改群信息的请求
    void requestChangeFlockInformation(const FlockInformation &);
    //发送修改群成员名片的请求
    void requestChangeFlockMemberRemark(const TempStrings &);
    //发送修改讨论组信息的请求
    ...
    //发送移动好友到其他分组的请求
    void requestMoveFriendToBox(const QString &friendID, const QString &title,
    ...
    //发送修改密码的请求
    void requestChangePwd(const QString &oldPwd, const QString &newPd);
...
private:
    ...
    UserInformation m_friendInf;
    FriendInformation m_friendSimInf;
